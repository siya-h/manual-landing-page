    ...
    return (
        <Box bgColor="light_tealish" overflow="auto" pt={['30px', '70px']}>
            <Grid templateColumns={["1fr", "repeat(2, 1fr)"]} mb={['20px', '40px']}>
                ...
                <Container display={['grid']} gridTemplateColumns={['repeat(2, 1fr)', 'repeat(2, 1fr)', 'repeat(4, 1fr)']} justifyContent={["space-between"]} mr={['0', '200px', '300px', '500px']} >
