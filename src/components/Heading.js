...
const Heading = () => {
    return (
        ...
        >
            ...
            <Text fontFamily="Helvetica" fontSize={['12px', '14px', '16px', '18px']} lineHeight={['12px', '18px', '24px', '30px']} w={['55%', '40%', '40%', '400px']} h={['60px', '65px', '75px',]} ml={['14px', '28px', '38px', '70px']} mt={['18px', '26px', 'initial', 'initial']} >We’re working around the clock to bring you a holistic approach to your wellness. From top to bottom, inside and out.</Text>
            <Box ml={['14px', '28px', '38px', '70px']} mt={['4px', '20px', '35px', '50px']} display="inline-block" >
                <Link to="/quiz">
                    <Button bg="tealish" w={['100px', '160px', '180px', '200px']} _hover={{ backgroundColor: 'pine_green' }} h={['38px', '40px', '44px', '48px']} boxShadow={['0px 10px 30px -20px rgba(0,0,0,0.5)']} borderRadius={['49.5px']} fontSize={['10px', '12px', '12px', '12px']} letterSpacing={['1px', 'initial', 'initial', '2.4px']} maxWidth="200px" minWidth="150px" fontFamily="Montserrat" color="white">TAKE THE QUIZ</Button>
                </Link>
            </Box>
