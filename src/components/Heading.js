...
const Heading = () => {
    return (
        ...
        >
            ...
            <Box fontSize={['22px', '36px','54px' ,'80px']} lineHeight={['22px', '42px', '62px','98px']} w={['55%', '55%', '60%','64%']} h={['15%', '20%','25%' ,'30%']} ml={['12px', '26px','34px', '60px']} mt={['15px', '25px','40px','90px']}>
            ...
            <Box ml={['14px', '28px', '38px','70px']} mt={['4px', '20px', '35px','50px']} display="inline-block" >
                <Link to="/quiz">
                    <Button bg="tealish" w={['100px', '160px','180px' ,'200px']} h={['38px', '40px','44px' ,'48px']} boxShadow={['0px 10px 30px -20px rgba(0,0,0,0.5)']} borderRadius={['49.5px']} fontSize={['10px', '12px', '12px', '12px']} letterSpacing={['1px',,,'2.4px']} maxWidth="200px" minWidth="150px" fontFamily="Montserrat" color="white">TAKE THE QUIZ</Button>
                </Link>
            </Box>
