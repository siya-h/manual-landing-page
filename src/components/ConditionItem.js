...
const ConditionItem = ({ item }) => {
    ...
    return (
        <Box margin={["30px auto", 'initial', 'initial', '80px auto']} maxWidth={['800px']} w={['initial', "90%", "80%", "100%"]}>
            ...
            <Box display={["block", "grid"]} gridTemplateColumns={['repeat(2, 1fr)']}>
                ...
                <Box w={["90%", 'initial', "85%", "75%"]} alignSelf="center" mt={['initial', 'initial', "15%", "35%"]} ml={["auto", 'initial', 'initial', "20%"]} mr={["auto", 'initial', 'initial', 'initial']} pos={["relative"]} left={['initial', 'initial', "0", "-10%"]}>
